...
class BadCreateBroadcastForm extends StatefulWidget {
  const BadCreateBroadcastForm({
    super.key,
  });

  @override
  State<BadCreateBroadcastForm> createState() => _BadCreateBroadcastFormState();
}

class _BadCreateBroadcastFormState extends State<BadCreateBroadcastForm> {
  ...
  Widget build(BuildContext context) {
    final BadCreateBroadcastCubit cubit = context.read<BadCreateBroadcastCubit>();

    return AppScaffold(
      title: LocaleKeys.broadcast_createBroadcast.tr(),
      child: Form(
        key: _formKey,
        child: BlocBuilder<BadCreateBroadcastCubit, BadCreateBroadcastState>(
          builder: (BuildContext context, BadCreateBroadcastState state) {
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      ElevatedButton(
                        ...
                        child: Text(
                          LocaleKeys.broadcast_createBroadcast.tr(),
                        ),
                      ),
                    ],
                  ),
